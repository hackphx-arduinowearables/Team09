...
NSDictionary* text5FontAttributes = @{NSFontAttributeName: [UIFont fontWithName: @"Chalkduster" size: [UIFont labelFontSize]], NSForegroundColorAttributeName: color9, NSParagraphStyleAttributeName: text5Style};
